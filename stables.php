  ...
  <body class="body-pattern">
    ...
    <div class="container content">
      <div class="container main-container rank-container">
        <div class="header">
          <h3>Classifica scuderie</h3>
        </div>

        <div class="table-responsive">
        <!-- classifica piloti -->
          <table id="stable-chart" class="table table-sm align-middle table-striped">
            <thead>
              <tr>
                <th scope="col">#</th>
            ...
            <tbody class="tbody">
              ...
              <?php
                ...
                $stables_res = getStables();
                
                $stables = [];

                for($i = 0; $i < $stables_res->num_rows; $i++) {
                  $row = $stables_res->fetch_assoc();
                  ...
                  array_push($stables, $stable);
                }

                echo '<script>createStableChart('.json_encode($stables).');</script>'
      ...
      <div class="container main-container graph-container">
        ...
        <div class="graph-content">
          <canvas id="stable-graph" class="graph-canvas" width="400" height="400"></canvas>
        <?php
          echo '<script>createStablesGraph('.json_encode($stables).');</script>'
        ?>
